...
export default function Intro() {
  return (
    <div className="container mx-auto p-5 ">
      ...
      <h1 className="text-2xl md:text-4xl text-left font-semibold my-4">
        Software engineer updated and with great background
      </h1>
      <p className="text-base md:text-lg text-left">
        With over 20 years of professional experience in the IT field, I have developed a variety of competencies in
        application development, software and applications quality assurance, data analysis and engineering solutions,
        my specialty being the IBM AS400 machine with all its utilities. I am achievement-focused and an open-minded
        leader who thrives searching for innovative solutions in challenging social and technical environments. I am
        currently exploring career opportunities in areas related to programming, mainframe administration, quality
        assurance, or data analysis.
      </p>
      <ul className="flex">
        <li>
          <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="linkedin inline-block mr-3">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <li>
          <a href="https://www.example.com" target="_blank" rel="noreferrer" className="x inline-block mr-3 mt-1">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
        ...
        <li>
          <a href="https://github.com" target="_blank" rel="noreferrer" className="github inline-block mr-3">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
